      ...
      <div className="flex-1 pb-20 overflow-y-auto space-y-2">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-foreground font-medium mb-1">No recommendations</p>
            <p className="text-sm text-muted-foreground text-center max-w-[240px]">Browse the explore page to discover products.</p>
          </div>
        ) : (
