import { Package, ExternalLink, User } from "lucide-react";
...
const InstafarmCard = ({ post, variant = "standard" }: InstafarmCardProps) => {
      ...
      >
        ...
        <div className="p-3 space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-medium text-foreground truncate">{post.farmer_name || "Farmer"}</span>
          </div>
          {post.caption && (
  ...
  // Standard variant — used on product detail, farmer profile
  return (
